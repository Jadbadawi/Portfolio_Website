      ...
      blocks: [
        ...
        },
        {
          ...
          figure: {
            ...
            caption: "Cured panel — surface wrinkling visible across the plate.",
            width: 733,
            height: 955,
          },
          body: [
            ...
            "The defect record below is part of the engineering argument, not an admission: wrinkling after debulking, wrinkling concentrated on the positive-angle plies, fibre separation in the spread-tow material, and a ply repair where a second ply was laid over a broken one.",
          ],
        },
        {
          kind: "gallery",
          ...
          figures: [
            ...
            },
            {
              ...
              caption: "Ply repair — a second ply over a broken one.",
              width: 960,
              height: 1280,
            },
          ],
      ...
      blocks: [
        {
          ...
          figures: [
            ...
            },
            {
              ...
              caption: "The Instron 1342 rig, hydraulic grips and video gauge on its tripod.",
              width: 960,
              height: 1280,
            },
            {
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          kind: "text",
          body: [
            "That pair is the plot that decides the question. Raw pairwise tests throw up differences; once Holm correction is applied for the number of comparisons actually being made, almost all of them disappear. The headline QI-versus-DD difference does not survive it.",
          ],
        },
        {
          kind: "note",
      ...
      blocks: [
        ...
        },
        {
          ...
          figure: {
            ...
            caption:
              "QI (top) and DD (bottom): full fracture surfaces left, magnified cross-sections across the ply orientations right. Matrix cracking is annotated on the DD surface.",
            width: 1600,
            height: 940,
          },
        },
