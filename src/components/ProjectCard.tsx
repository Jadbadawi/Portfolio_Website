...
export default function ProjectCard({
  ...
  return (
    <Reveal>
      <article className="group relative border-t border-line py-10 sm:py-12">
        <div
        ...
        >
          ...
          >
            <Image
              ...
              // The first card is the LCP element on desktop; every other
              // image on the page stays lazy, next/image's default.
